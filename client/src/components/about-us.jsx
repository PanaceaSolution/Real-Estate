  ...
  return (
   < div className='px-6'>
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center max-w-6xl mx-auto p-4">
        <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0">
          <div className="mb-8">
            {/* Company values */}
            <h2 className="text-xl md:text-2xl font-semibold mb-4">Company Values:</h2>
            <p className="mb-3">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-4">Morals:</h2>
            <p className="mb-3">
      ...
      <div className="mt-12 text-center">
        <h2 className="text-4xl md:text-6xl font-bold mb-8 md:mb-12">
          Meet Our <span className="text-purple-800">Team Members</span>
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex flex-col items-center shadow-xl p-4 bg-white rounded-lg transform transition-transform duration-300 hover:scale-105 w-full sm:w-1/2 md:w-1/4">
              <img
                src={image}
                alt={`Team Member ${i}`}
                className="w-24 h-24 md:w-32 md:h-32 object-cover rounded-full border-4 border-gray-200 shadow-md"
              />
              <p className="mt-4 text-base md:text-lg font-semibold text-gray-800">Team Member {i}</p>
            </div>
          ))}
        </div>
      </div>
